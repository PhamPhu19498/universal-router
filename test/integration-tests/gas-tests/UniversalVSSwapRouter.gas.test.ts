import { encodeSqrtRatioX96, FeeAmount, Pool, TickMath } from '@phuphamdeltalabs/v3sdk'
import { Pair, Route as V2RouteSDK } from '@phuphamdeltalabs/v2-sdk'
import { Route as V3RouteSDK } from '@phuphamdeltalabs/v3sdk'
import { encodePath, expandTo18Decimals } from '../shared/swapRouter02Helpers'
import { BigNumber } from 'ethers'
import { SwapRouter } from '@phuphamdeltalabs/router-sdk'
import {
...
import { CurrencyAmount, Percent, Token, TradeType } from '@phuphamdeltalabs/sdkcore'
import snapshotGasCost from '@uniswap/snapshot-gas-cost'
import { IRoute, Trade } from '@phuphamdeltalabs/router-sdk'
const { ethers } = hre
